...
function taskFactory(
	...
	function _formatDate() {
		const _parsedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(inputDuedate);
		if ((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(_parsedDate)) return `Today, ${(0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(_parsedDate, "p")}`;
		else return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(_parsedDate, "do MMM y, p");
	}
...
const todolist = (() => {
	...
	function create(...args) {
		const _newTask = (0,_taskFactory__WEBPACK_IMPORTED_MODULE_1__.taskFactory)(...args);
		_todoList.push(_newTask);
		const _index = _todoList.indexOf(_newTask);
		_storageHandler__WEBPACK_IMPORTED_MODULE_2__.storage.save(_index, _newTask);
	}
	...
	function edit(index = null, type, value) {
		...
		_storageHandler__WEBPACK_IMPORTED_MODULE_2__.storage.modify(index, _updatedTask);
	}

	function removeAt(index) {
		_todoList.splice(index, 1);
		_storageHandler__WEBPACK_IMPORTED_MODULE_2__.storage.removeAt(index);
	}
...
if (_storageHandler__WEBPACK_IMPORTED_MODULE_2__.storage.size() !== 0) {
	for (let i = 0; i < localStorage.length; i++) {
		const restoredTask = (0,_taskFactory__WEBPACK_IMPORTED_MODULE_1__.taskFactory)(...Object.values(_storageHandler__WEBPACK_IMPORTED_MODULE_2__.storage.getFrom(i)));
